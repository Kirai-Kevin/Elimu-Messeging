...
function b() {
  return this.bodyUsed = false, this._initBody = function(t2) {
    ...
    if (s2)
      return s2;
    if (this._bodyBlob)
      return t2 = this._bodyBlob, e2 = new FileReader(), r2 = l(e2), o2 = /charset=([A-Za-z0-9_-]+)/.exec(t2.type), n2 = o2 ? o2[1] : "utf-8", e2.readAsText(t2, n2), r2;
    if (this._bodyArrayBuffer)
...
var E = "undefined" != typeof globalThis && globalThis || "undefined" != typeof self && self || "undefined" != typeof global && global || { fetch: null };
E.fetch || (E.fetch = _);
//# sourceMappingURL=__bundle-46d64517-CDLM3SUL.js.map

...
var _tslib = require('./bundle-CUZ9h-Pd.js');
var SendbirdContext = require('./bundle-CBsGg8fP.js');
var React = require('react');
var useSendbird = require('./bundle-CdMxPwq1.js');
var utils = require('./bundle-BfXuy6S7.js');
...
var useMessageSearch = function () {
    ...
    var actions = React.useMemo(function () { return ({
        setCurrentChannel: function (channel) { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { currentChannel: channel, initialized: true })); }); },
        setChannelInvalid: function () { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { currentChannel: null, initialized: false })); }); },
        ...
        setQueryInvalid: function () { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { isInvalid: true })); }); },
        startMessageSearch: function () { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { isInvalid: false, loading: false })); }); },
        startGettingSearchedMessages: function (query) { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { loading: true, currentMessageSearchQuery: query })); }); },
        ...
        resetSearchString: function () { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { allMessages: [] })); }); },
        setSelectedMessageId: function (messageId) { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { selectedMessageId: messageId })); }); },
        handleRetryToConnect: function () { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { retryCount: state.retryCount + 1 })); }); },
        // Looks exactly same as handleRetryToConnect but keep just for backward compatibility
        setRetryCount: function () { return store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { retryCount: state.retryCount + 1 })); }); },
    }); }, [store]);
...
//# sourceMappingURL=bundle-DDmd55LZ.js.map

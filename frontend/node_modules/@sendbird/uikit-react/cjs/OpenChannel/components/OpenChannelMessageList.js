...
var index$1 = require('../../chunks/bundle-D7MlQVvs.js');
        ...
        if (allMessages.length > 0) {
            return (allMessages.map(function (message, index) {
                ...
                var _b = isMessageGroupingEnabled
                    ? Channel_utils_compareMessagesForGrouping.compareMessagesForGrouping(previousMessage, message, nextMessage, stringSet)
